...
### 📁 ファイル: `01_getting_started/getting_started.sql`

### セクション1: ウェアハウスの作成（行60-150）
...
### セクション7: ユニバーサル検索（行434-460）

💬 **説明ポイント**:
> 「ユニバーサル検索を使うと、アカウント内のオブジェクトを自然言語で検索できます。『Which truck franchise has the most loyal customer base?』のように質問することも可能です。」

---

## Module 02: データパイプライン

### 📁 ファイル: `02_data_pipelines/data_pipelines.sql`
...
### セクション3: Dynamic Tables（行126-215）
...
### 📁 ファイル: `03_cortex_ai/cortex_ai.sql`
...
### セクション3: EXTRACT_ANSWER（行120-158）
...
### セクション4: AI_SUMMARIZE_AGG（行159-195）
...
### 📁 ファイル: `04_governance/governance.sql`
...
### 📁 ファイル: `05_apps_collaboration/apps_collaboration.sql`
