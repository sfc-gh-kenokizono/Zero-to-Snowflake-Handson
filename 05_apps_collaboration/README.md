...
| `slides/05_apps_and_collaboration.pdf` | 参考PDF | ※外部リンクあり、本READMEを推奨 |

> ⚠️ **注意**: PDFは参考資料です。手順はこのREADMEと`apps_collaboration.sql`に従ってください。
...
3. [`apps_collaboration.sql`](./apps_collaboration.sql) の内容をコピー＆ペースト
