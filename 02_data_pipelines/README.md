...
| ファイル | 説明 | 使い方 |
|---------|------|--------|
| [`02_data_pipelines.sql`](./02_data_pipelines.sql) | **メインスクリプト** | Snowsightで開いて順番に実行 |
...
1. **Snowsight** にログイン
2. GitHubで [`02_data_pipelines.sql`](./02_data_pipelines.sql) を開き、**Raw** → 全文コピー
